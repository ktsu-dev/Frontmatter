...
public class PropertyMergerTests
{
	...
	[TestMethod]
	public void MergeSimilarProperties_AggressiveStrategy_WithSimpleCase()
	{
		// Arrange
		var frontmatter = new Dictionary<string, object>
		{
	...
	[TestMethod]
	public void MergeSimilarProperties_WithArrayValues_MultipleStrategies()
	{
		// Arrange
		var frontmatter = new Dictionary<string, object>
		{
		...
		// Assert - verify some consistent behavior
